...
static char component[] = "[TRB_MCP23017][mcp23017_disable_pullup]";
...
TEST_CASE("when_pin_is_on_B_then_register_is_MCP23x17_GPPUB", component)
{
	...
	/* when pin 8, or IO0 on PORTB, is disabled */
	err = mcp23017_disable_pullup(8);
